...
\newacronym{tdm}{TDM}{temporal distribution matching}
\newacronym{tdc}{TDC}{temporal distribution characterization}
\newacronym{tcs}{TCS}{temporal covariate shift}
\newacronym{adarnn}{AdaRNN}{adaptive recurrent neural network}
%%%Author macros
